...
// FIRST approach is the most optimal in terms of TC - O(n) and SC - O(1) (excluding output space)
class Solution {
...
// SECOND approach- follow up (compute without reversing) TC - O(n) and SC - O(n) 
